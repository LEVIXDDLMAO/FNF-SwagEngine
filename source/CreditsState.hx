...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Swag Engine Team'],
			['LeviXD',              'levixd', 		'Main Programmer of Swag Engine',						'https://github.com/LEVIXDDLMAO',	'444444'], //what an loser all by himself?
			[''],
			['Psych Engine Team'],
			...
			['PolybiusProxy',		'polybiusproxy',			'.MP4 Video Loader Library (hxCodec)',							'https://twitter.com/polybiusproxy',	'DCD294'],
